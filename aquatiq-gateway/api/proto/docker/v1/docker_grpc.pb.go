...
const (
	DockerService_ListContainers_FullMethodName     = "/aquatiq.gateway.docker.v1.DockerService/ListContainers"
	DockerService_GetContainer_FullMethodName       = "/aquatiq.gateway.docker.v1.DockerService/GetContainer"
	DockerService_StartContainer_FullMethodName     = "/aquatiq.gateway.docker.v1.DockerService/StartContainer"
	DockerService_StopContainer_FullMethodName      = "/aquatiq.gateway.docker.v1.DockerService/StopContainer"
	DockerService_RestartContainer_FullMethodName   = "/aquatiq.gateway.docker.v1.DockerService/RestartContainer"
	DockerService_GetContainerLogs_FullMethodName   = "/aquatiq.gateway.docker.v1.DockerService/GetContainerLogs"
	DockerService_GetContainerStats_FullMethodName  = "/aquatiq.gateway.docker.v1.DockerService/GetContainerStats"
	DockerService_ListImages_FullMethodName         = "/aquatiq.gateway.docker.v1.DockerService/ListImages"
	DockerService_ListNetworks_FullMethodName       = "/aquatiq.gateway.docker.v1.DockerService/ListNetworks"
	DockerService_ListVolumes_FullMethodName        = "/aquatiq.gateway.docker.v1.DockerService/ListVolumes"
	DockerService_GetSystemInfo_FullMethodName      = "/aquatiq.gateway.docker.v1.DockerService/GetSystemInfo"
	DockerService_GetAquatiqServices_FullMethodName = "/aquatiq.gateway.docker.v1.DockerService/GetAquatiqServices"
)
...
var DockerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "aquatiq.gateway.docker.v1.DockerService",
